...
const Dnavbar = () => {
  ...
  const validateForm = () => {
    ...
    if (!r_email || !r_email.endsWith("nu-moa.edu.ph"))
      formErrors.r_email = "Valid email is required (Must be nu-moa.edu.ph account)";
    ...
    <>
      <div className="navbar bg-nucolor1 text-white2 border-b-4 border-nucolor3 drop-shadow-md">
        ...
        <div className="navbar-end">
          ...
          {/* hey chatgpt, you should only focus starting here (in the html part) */}
          {/* Sign up modal */}
      ...
      <form>
        <div className="grid sm:grid-cols-2 gap-y-5 gap-x-5">
          <label className="block text-sm">
            ...
            <select defaultValue={'What are you?'} onChange={(e)=>{setRusertype(e.target.value)}} className={`font-sans select select-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_usertype ? 'border-red-500' : ''}`}>
            ...
            {errors.r_usertype && <p className="text-red-500 text-xs mt-1">{errors.r_usertype}</p>}
          </label>
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_mname ? 'border-red-500' : ''}`}
              placeholder="Enter middle name"
            />
            {errors.r_mname && <p className="text-red-500 text-xs mt-1">{errors.r_mname}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_fname ? 'border-red-500' : ''}`}
              placeholder="Enter first name"
            />
            {errors.r_fname && <p className="text-red-500 text-xs mt-1">{errors.r_fname}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_lname ? 'border-red-500' : ''}`}
              placeholder="Enter last name"
            />
            {errors.r_lname && <p className="text-red-500 text-xs mt-1">{errors.r_lname}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_email ? 'border-red-500' : ''}`}
              placeholder="Enter email"
            />
            {errors.r_email && <p className="text-red-500 text-xs mt-1">{errors.r_email}</p>}
          </div>
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_mnum ? 'border-red-500' : ''}`}
              placeholder="Enter mobile number"
            />
            {errors.r_mnum && <p className="text-red-500 text-xs mt-1">{errors.r_mnum}</p>}
          </div>
          <label className="block text-sm">
            <p className="mb-2">Department</p>
            <select onChange={(e)=>{setRdep(e.target.value)}} className={`font-sans select select-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_mnum ? 'border-red-500' : ''}`}>
              <option disabled selected>
                Choose Department
              </option>
            ...
            {errors.r_dep && <p className="text-red-500 text-xs mt-1">{errors.r_dep}</p>}
          </label>
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_studnum ? 'border-red-500' : ''}`}
              placeholder="Enter student number"
            />
            {errors.r_studnum && <p className="text-red-500 text-xs mt-1">{errors.r_studnum}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_datehired ? 'border-red-500' : ''}`}
              placeholder="Enter date hired"
            />
            {errors.r_datehired && <p className="text-red-500 text-xs mt-1">{errors.r_datehired}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_password ? 'border-red-500' : ''}`}
              placeholder="Enter password"
            />
            {errors.r_password && <p className="text-red-500 text-xs mt-1">{errors.r_password}</p>}
          </div>
          <div>
            ...
            <input
              ...
              className={`input input-bordered w-full text-sm px-4 py-3.5 rounded-md outline-blue-500 ${errors.r_confirmPassword ? 'border-red-500' : ''}`}
              placeholder="Enter confirm password"
            />
            {errors.r_confirmPassword && <p className="text-red-500 text-xs mt-1">{errors.r_confirmPassword}</p>}
          </div>
        </div>
