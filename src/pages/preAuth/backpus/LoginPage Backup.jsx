  ...
  return (
    ...
    <div className='glue'>
      ...
      <div className='inputs'>
        ...
        <div className='input input-bordered bg-gray-200'>
        ...
        <div className='input input-bordered bg-gray-200'>
          ...
          <input className='' type={showPassword ? 'text' : 'password'}
      ...
      <div>
        <p className="labelz justify-end">Don't have an account yet?</p>
      </div>

      <div className='submit-container'>
        <div className='btn btn-md text-lg submit text-whitey bg-nucolor1 hover:bg-nucolor7' onClick={login_btn}>
          Sign In
        </div>
      </div>
