  ...
  return (
    <div className="flex flex-col justify-between min-h-screen">
      <div className="max-w-7xl mx-auto p-8 flex-grow">
        <h2 className="text-3xl font-bold mb-8 text-gray-900">"ADMIN" Evaluate Application for Engagement Appraisals</h2>
            ...
            <ul className="space-y-4">
              {filteredActivities.map((activity) => (
                <li
                  ...
                  onClick={() => navigate(`/admin/engagement-appraisals/${activity._id}`)}
                >
                  {activity.title}
                </li>
              ))}
